...
const About = () => {
    const { data: skillsData, loading: skillsLoading, error: skillsError } = useFetch("/data/skills.json");
    const { data: interestsData, loading: interestsLoading, error: interestsError } = useFetch("/data/interests.json");
    ...
    return (
        <>
            {interestsLoading || skillsLoading ? (
                ...
                <section className="about wrapper wrapper--pages">
